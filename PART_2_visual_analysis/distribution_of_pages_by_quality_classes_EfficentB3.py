...
html_path = SCRIPT_DIR / "report_pptx_efficientB3.html"
...
ax.set_ylabel("Частка сторінок за моделлю EfficentB3")
# ax.set_xlabel("Документ")
# ax.set_title(
#     "Розподіл сторінок за класами якості для кожного документа (EfficentB3, PDF→DOCX)"
# )
